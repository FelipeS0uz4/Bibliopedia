...
def salvarComentario():    
    ...
    comentarioCorrigido = {'idLivro': PesquisarId(comentario.get("IdLivro")),
                            'idUsuario' : comentario.get('IdUsuario'),
                            'comentarios' : comentario.get('Comentario'),
                            'nota':comentario.get('ranting')}
