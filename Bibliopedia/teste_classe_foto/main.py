...
blueprint.route('/livros/autor/<int:idAutor>', methods=['POST'])(AdicionarNovoLivro)
blueprint.route('/autor/<nome_autor>',methods=['GET'])(informacoes_autor)

##Usuarios

blueprint.route('/usuarios', methods=['GET'])(listarTodosUsuario)
blueprint.route('/usuario/<TypeClient>', methods=['POST'])(salvarUsuario) ##Caso seja melhor enviar no Json e só apagar o Type
